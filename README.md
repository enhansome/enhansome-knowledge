...
* [Taro 多端统一开发框架](https://github.com/NervJS/taro) ⭐ 37,690 | 🐛 1,594 | 🌐 TypeScript | 📅 2026-09-23
...
* [Airbnb JavaScript](https://github.com/airbnb/javascript?utm_source=gold_browser_extension) ⭐ 148,261 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16 \*\*
...
* [Nginx](https://github.com/nginx/nginx) ⭐ 31,721 | 🐛 467 | 🌐 C | 📅 2026-09-16 ☆☆☆
...
* [Google V8](https://github.com/v8/v8) ⭐ 25,257 | 🐛 23 | 🌐 C++ | 📅 2026-09-23 ☆☆☆
...
* 中级 ☆☆
  * [33 Concepts Every JavaScript Developer Should Know](https://github.com/leonardomso/33-js-concepts?utm_source=gold_browser_extension) ⭐ 66,529 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-10
...
* 高级 ☆☆☆
  * TypeScript
    * [TypeScript 总体架构](https://github.com/Microsoft/TypeScript/wiki/Architectural-Overview) ⭐ 111,165 | 🐛 5,002 | 🌐 Go | 📅 2026-09-23
  ...
  * JavaScript 如何工作
    * [在 V8 引擎里 5 个优化代码的技巧](https://github.com/xitu/gold-miner/blob/master/TODO/how-javascript-works-inside-the-v8-engine-5-tips-on-how-to-write-optimized-code.md) ⭐ 34,352 | 🐛 15 | 📅 2024-04-17
    * [内存管理 + 处理常见的4种内存泄漏](https://github.com/xitu/gold-miner/blob/master/TODO/how-javascript-works-memory-management-how-to-handle-4-common-memory-leaks.md) ⭐ 34,352 | 🐛 15 | 📅 2024-04-17
    * [事件循环和异步编程的崛起 + 5个如何更好的使用 async/await 编码的技巧](https://github.com/xitu/gold-miner/blob/master/TODO/how-javascript-works-event-loop-and-the-rise-of-async-programming-5-ways-to-better-coding-with.md) ⭐ 34,352 | 🐛 15 | 📅 2024-04-17
    * [深入剖析 WebSockets 和拥有 SSE 技术 的 HTTP/2，以及如何在二者中做出正确的选择](https://github.com/xitu/gold-miner/blob/master/TODO/how-javascript-works-deep-dive-into-websockets-and-http-2-with-sse-how-to-pick-the-right-path.md) ⭐ 34,352 | 🐛 15 | 📅 2024-04-17
    * [对比 WebAssembly + 为什么在某些场景下它比 JavaScript 更合适](https://github.com/xitu/gold-miner/blob/master/TODO1/how-javascript-works-a-comparison-with-webassembly-why-in-certain-cases-its-better-to-use-it.md) ⭐ 34,352 | 🐛 15 | 📅 2024-04-17
    * [Web Worker 的内部构造以及 5 种你应当使用它的场景](https://github.com/xitu/gold-miner/blob/master/TODO/how-javascript-works-the-building-blocks-of-web-workers-5-cases-when-you-should-use-them.md) ⭐ 34,352 | 🐛 15 | 📅 2024-04-17
    * [对引擎、运行时、调用堆栈的概述](https://juejin.im/post/5a05b4576fb9a04519690d42)
    * [内存管理速成教程](https://mp.weixin.qq.com/s/sVcGRUZqILCVgfhzRyODTg)
* 扩展
  * [30S JS](https://github.com/Chalarangelo/30-seconds-of-code) ⭐ 129,193 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-11 ☆☆
  * [33 Concepts Every JavaScript Developer Should Know ](https://github.com/leonardomso/33-js-concepts?utm_source=gold_browser_extension#1-call-stack) ⭐ 66,529 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-10
...
* 自动化测试
  * [UI 自动化测试](https://github.com/AirtestProject/Airtest) ⭐ 9,576 | 🐛 485 | 🌐 Python | 📅 2026-03-23 ☆☆☆
...
* [what-happens-when](https://github.com/alex/what-happens-when) ⭐ 43,327 | 🐛 2,066 | 📅 2024-08-19(输入 URL 后浏览器发生了什么) ☆☆
...
* [前端精读周刊](https://github.com/dt-fe/weekly) ⭐ 31,222 | 🐛 16 | 🌐 JavaScript | 📅 2024-09-09
...
* [rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,197 | 🐛 37 | 🌐 Rust | 📅 2026-09-21：这个项目包含小练习，让你习惯阅读和编写 Rust 代码。
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,509 | 🐛 10 | 🌐 Rust | 📅 2026-09-22 ：Rust 代码和资源的精选列表
* [Comprehensive Rust](https://github.com/google/comprehensive-rust) ⭐ 33,376 | 🐛 160 | 🌐 Rust | 📅 2026-09-17： Google 打造的 Android 系列课
* [Book|The Rust Programming Language](https://github.com/rust-lang/book) ⭐ 18,326 | 🐛 433 | 🌐 Rust | 📅 2026-09-02："The Rust Programming Language"
